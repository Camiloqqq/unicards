...
import { coleccionStyle as styles } from './style/coleccionStyle';
...
export default function home({ navigation }) {
  ...
  <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('coleccion')}>
    <Ionicons name="albums" size={20} color="#fff" style={styles.icon} />
    <Text style={styles.tabActive}>Colección</Text>
  </TouchableOpacity>
</View>
    </SafeAreaView>
  );
